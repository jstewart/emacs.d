...
(setq erc-email-userid "jason.m.stewart@gmail.com")
...
(defun jstew/start-irc ()
  ...
  (when (y-or-n-p "IRC? ")
    ...
    (erc :server "irc.freenode.net" :port 6667
	 :nick "jstew" :full-name "Jason Stewart" :password "sootroom")
    (setq erc-autojoin-channels-alist '(("freenode.net" "#rubyonrails" "#django")))))
